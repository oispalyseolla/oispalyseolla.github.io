...
HTMLActuator.prototype.updateScore = function (score) {
  ...
  if (difference > 0) {
    ...
    snd = new Audio("https://oispalyseolla.tk/snd/pen/pencil_scribble" + Math.floor(Math.random() * 3).toString() + ".mp3")
  ...
  {
    snd = new Audio("https://oispalyseolla.tk/snd/paper/page_turning" + Math.floor(Math.random() * 3).toString() + ".mp3");
  }
...
HTMLActuator.prototype.goKatko = function () {
    ...
    snd = new Audio("https://oispalyseolla.tk/snd/katkolle.mp3");
    snd.play();
    ...
    messageElement.setAttribute('src',"https://oispalyseolla.tk/img/katko.png");
    //messageElement.textContent = message;
    //var left = 'left: 37%;';
    //var top = 'top: 10%;';
