...
dogeSayings = [
  ...
  'Oisko juomatauolle?',
  'Ei jaksa.',
  'Kymppi tulee liikasta!',
  'Jomppasonni hittaa p',
  'Polttopallo <3',
  'Helppoo ku mikä!',
  'Cooper-testi millo?',
  'Ei sinne!!',
...
HTMLActuator.prototype.message = function (won) {
  ...
  var message = won ? "10 liikunnasta!" : "4 liikunnasta!";
...
HTMLActuator.prototype.goKatko = function () {
    ...
    messageElement.setAttribute('src',"https://www.oispalyseolla.tk/img/katko.png");
    //messageElement.textContent = message;
    //var left = 'left: 37%;';
    //var top = 'top: 10%;';
